...
public class StreamDemo {
	...
	public static void main(String[] args) {
		...
		names.stream().filter(s -> s.contains("S")).forEach(s->System.out.println(s));//printing the name start with "s"
		...
		List<String> lis1 = Arrays.asList("Gopi","Sreevedh","Appu"); // here converting an array to list and storing it in to a list
		...
		//concatStream.sorted().forEach(s->System.out.println(s)); // sorting and printing the stream
